...
public class AudioManager : MonoBehaviour
{
    ...
    {
        // check if two scenes have the same music
...
public enum AudioId { UISelect, HouseBurning, ClosingMenu, OpenMenu, HoveringOverMenu, ButtonClick, GrandmaScared, ScissorsCutting}
